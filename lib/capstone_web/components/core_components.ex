defmodule CapstoneWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(CapstoneWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(CapstoneWeb.Gettext, "errors", msg, opts)
    end
  end
