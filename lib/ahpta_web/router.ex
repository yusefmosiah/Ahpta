defmodule AhptaWeb.Router do
  use AhptaWeb, :router

  import AhptaWeb.UserAuth

  pipeline :browser do
    plug(:accepts, ["html"])
    plug(:fetch_session)
    plug(:fetch_live_flash)
    plug(:put_root_layout, {AhptaWeb.Layouts, :root})
  ...
  if Application.compile_env(:ahpta, :dev_routes) do
    ...
    scope "/dev" do
      ...
      live_dashboard("/dashboard", metrics: AhptaWeb.Telemetry)
  ...
  scope "/", AhptaWeb do
    ...
    live_session :redirect_if_user_is_authenticated,
      on_mount: [{AhptaWeb.UserAuth, :redirect_if_user_is_authenticated}] do
  ...
  scope "/", AhptaWeb do
    ...
    live_session :current_user,
      on_mount: [{AhptaWeb.UserAuth, :mount_current_user}] do
